...
using static ProfileCAM.Core.Geometries.DoubleExtensions;
using static ProfileCAM.Core.Geometries.IntExtensions;
using static ProfileCAM.Core.MCSettings.EHeads;
