   ...
   public class SettingServices {
      ...
      SettingServices () {
         ...
         if (!Directory.Exists (fChassisDrive)) {
            ...
            fChassisFolderPath = Path.Combine (userHomePath, "ProfileCAM");
         } else
            fChassisFolderPath = Path.Combine (fChassisDrive, "ProfileCAM");

         // Define the full path to the settings file
         settingsFilePath = Path.Combine (fChassisFolderPath, "ProfileCAM.User.Settings.JSON");
