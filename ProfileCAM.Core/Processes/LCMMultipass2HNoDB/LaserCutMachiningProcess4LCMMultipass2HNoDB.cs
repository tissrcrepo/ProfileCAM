...
namespace ProfileCAM.Core.Processes.LCMMultipass2HNoDB {
   ...
   public class GenesysHub4GenesysHub4LCMMultipass2HNoDB : IGenesysHub {
      ...
      #region Constructor
      public GenesysHub4GenesysHub4LCMMultipass2HNoDB () {
         MachiningTool = new Nozzle (9.0, 100.0, 100);
         mGCodeGenerator = new GCodeGenerator4LCMMultipass2HNoDB (this, true/* Left to right machining*/);
         mGCodeParser = new GCodeParser4LCMMultipass2HNoDB ();
         CutHoles = true;
         CutMark = true;
         CutNotches = true;
         Cutouts = true;
      ...
      GCodeParser4LCMMultipass2HNoDB mGCodeParser;
