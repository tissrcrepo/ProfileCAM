...
namespace ChassisCAM.Core {
   ...
   public partial class MCSettings : INotifyPropertyChanged {
      ...
      public MCSettings () {
         ...
         mCutCutouts = true;
         mCutMarks = true;
         if (System.IO.Directory.Exists ("W:\\ChassisCAM\\Sample"))
            NCFilePath = "W:\\ChassisCAM\\Sample";
         else
            NCFilePath = "";
         ...
         WorkpieceOptionsFilename = @"W:\ChassisCAM\LCM2HWorkpieceOptions.json";
         DeadbandWidth = 980.0;
      ...
      public void LoadSettingsFromJson (string filePath) {
         if (File.Exists (filePath)) {
            ...
            MessageBox.Show ($"Settings file ChassisCAM.User.Settings.JSON not found. Created default settings",
