...
public partial class App : Application {
   ...
   void InitializeLogging () {
      try {
         ...
         string appFolderPath = Path.Combine (localAppDataPath, "ChassisCAM");
         ...
         File.WriteAllText (mLogFilePath, $"--- ChassisCAM Startup Log [{DateTime.Now}] ---\n");
         ...
         File.AppendAllText (mLogFilePath, $"--- ChassisCAM Startup Log [{DateTime.Now}] ---\n");
      }
   }
